...
namespace 調劑台管理系統_VM_
{
    public partial class Form1 : Form
    {
        ...
        private void SqL_DataGridView_Log_DataGridRowsChangeRefEvent(ref List<object[]> RowsList)
        {
            ...
            RowsList.Sort(new LogComparerby());
        }
