            ...
            for (int i = 0; i < this.List_EPD583_本地資料.Count; i++)
            {
                ...
                for (int k = 0; k < boxes.Count; k++)
                {
                    ...
                    else
                    {
                        ...
                        if (boxes[k].BackColor.ToColorString() == Color.Red.ToColorString() && boxes[k].ForeColor.ToColorString() == Color.White.ToColorString())
                        {
                            警訊藥品 = true.ToString().ToUpper();
                        }
                        else if (boxes[k].BackColor.ToColorString() == Color.White.ToColorString() && boxes[k].ForeColor.ToColorString() == Color.Black.ToColorString())
                        {
